...
<script>
  ...
  function initMap() {
    ...
    var route = [];
    route.push(new google.maps.LatLng(10.016191,105.76543));
    route.push(new google.maps.LatLng(10.0324412,105.7665369));
    route.push(new google.maps.LatLng(10.034023,105.779841));
    var polylineOptions = {
        path: route
    };
