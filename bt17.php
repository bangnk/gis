    ...
    <div class='row header'>
        <form class="form-inline" id='gis_form'>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="addressInputText" name="address" style='width: 300px;'>
            </div>
            <button type="submit" class="btn btn-default" id="sbutton">Get Coordinates</button>
...
<script>
  ...
  $('form').submit(function(){
    if (document.forms["gis_form"]["address"].value != '') {
        var address = document.forms["gis_form"]["address"].value;
